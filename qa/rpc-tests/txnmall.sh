...
globalboostyd=${1}/globalboostyd
CLI=${1}/globalboost-y-cli
...
$globalboostyd $B1ARGS &
B1PID=$!

D2=${D}/node2
CreateDataDir $D2 port=11010 rpcport=11011
B2ARGS="-datadir=$D2 -debug"
$globalboostyd $B2ARGS &
B2PID=$!
...
echo "Done, globalboostyd's shut down. To rerun/poke around:"
echo "${1}/globalboostyd -datadir=$D1 -daemon"
echo "${1}/globalboostyd -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall globalboostyd; rm -rf test.*"
exit 0
