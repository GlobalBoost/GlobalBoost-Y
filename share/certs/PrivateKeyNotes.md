...
unlocked to sign the globalboost-y-Qt.app bundle.
...
allowing somebody to distribute a globalboost-y-Qt.app or globalboost-y-qt-setup.exe with a valid
...
that the globalboost-y-qt.exe file inside the installer had not been tampered with.
