...
class NetTest(GlobalBoostTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=8226)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 8226)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=8226), {"success": False})
