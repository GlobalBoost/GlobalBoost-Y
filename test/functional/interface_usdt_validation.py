...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/globalboost/globalboost/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(GlobalBoostTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/globalboost/globalboost/blob/master/doc/tracing.md#tracepoint-validationblock_connected
