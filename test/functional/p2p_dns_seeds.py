...
class P2PDNSSeeds(GlobalBoostTestFramework):
    ...
    def init_arg_tests(self):
        ...
        # Restore default globalboostd settings
        self.restart_node(0)
    ...
    def existing_outbound_connections_test(self):
        ...
        self.nodes[0].addpeeraddress("192.0.0.8", 8226)
    ...
    def force_dns_test(self):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=["Loading addresses from DNS seed"], timeout=12):
            # -dnsseed defaults to 1 in globalboostd, but 0 in the test framework,
