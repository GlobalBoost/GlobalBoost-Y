...
class RawTransactionsTest(GlobalBoostTestFramework):
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 BSTY/kvB
        ...
        # Fee rate is 0.20000000 BSTY/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/globalboost/globalboost/issues/20579)
