...
Verify that a globalboostd node can use an external signer command.
...
class RPCSignerTest(GlobalBoostTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart globalboostd with -signer=<cmd>',
