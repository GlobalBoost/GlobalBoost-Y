...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/globalboost/globalboost/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(GlobalBoostTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our globalboostd node")
