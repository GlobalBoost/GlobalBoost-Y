...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/globalboost/globalboost/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(GlobalBoostTestFramework):
