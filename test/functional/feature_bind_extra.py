...
"""
Test starting globalboostd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(GlobalBoostTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that globalboostd has bound on "::1" (for RPC) and "::" (for P2P).
