...
"""GlobalBoost test framework primitive and message structures
...
class CAddress:
    ...
    # see https://github.com/globalboost/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
    NET_I2P = 5
...
class CBlockLocator:
    ...
    def serialize(self):
        r = b""
        r += struct.pack("<i", 0)  # GlobalBoost Core ignores version field. Set it to 0.
...
class msg_version:
    ...
    def deserialize(self, f):
        ...
        # But, unconditionally check it to match behaviour in globalboostd
        try:
