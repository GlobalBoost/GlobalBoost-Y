...
"""Test objects for interacting with a globalboostd node over the p2p protocol.

The P2PInterface objects interact with the globalboostd nodes under test using the
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, *, net, timeout_factor):
        ...
        logger.debug('Connecting to GlobalBoost Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor):
        ...
        logger.debug('Listening for GlobalBoost Node with id: {}'.format(connect_id))
