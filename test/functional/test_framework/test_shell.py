...
class TestShell:
    """Wrapper Class for GlobalBoostTestFramework.

    The TestShell class extends the GlobalBoostTestFramework
    ...
    class __TestShell(GlobalBoostTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GlobalBoostTestFramework child class.
            self.num_nodes = 1
