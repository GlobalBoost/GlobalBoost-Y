...
class ConfArgsTest(GlobalBoostTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        # Check that startup fails if conf= is set in globalboost.conf or in an included conf file
        bad_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'globalboost_bad.conf')
        ...
        with open(os.path.join(self.nodes[0].datadir, 'globalboost.conf'), 'a', encoding='utf-8') as conf:
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'globalboost_main.conf')
    ...
    def run_test(self):
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_globalboost.conf")
