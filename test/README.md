...
interfaces.
- [util](/test/util) which tests the utilities (globalboost-util, globalboost-tx, ...).
...
Before tests can be run locally, GlobalBoost Core must be built.  See the [building instructions](/doc#building) for help.
