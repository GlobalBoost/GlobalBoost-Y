...
export CONTAINER_NAME=ci_native_nowallet_libglobalboostkernel
...
export GOAL="install"
export NO_WERROR=1
export GLOBALBOOST_CONFIG="--enable-reduce-exports CC=clang-8 CXX='clang++-8 -stdlib=libc++' --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
