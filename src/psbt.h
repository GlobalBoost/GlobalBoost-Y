...
#ifndef GLOBALBOOST_PSBT_H
#define GLOBALBOOST_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual GlobalBoost transaction.) Returns true if the merge succeeded, false otherwise. */
