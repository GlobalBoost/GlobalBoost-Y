...
#if defined(__linux__) && defined(ENABLE_ARM_SHANI) && !defined(BUILD_GLOBALBOOST_INTERNAL)
#include <sys/auxv.h>
#include <asm/hwcap.h>
#endif

#if defined(MAC_OSX) && defined(ENABLE_ARM_SHANI) && !defined(BUILD_GLOBALBOOST_INTERNAL)
#include <sys/types.h>
...
#if defined(ENABLE_X86_SHANI) && !defined(BUILD_GLOBALBOOST_INTERNAL)
    if (have_x86_shani) {
...
#if defined(ENABLE_ARM_SHANI) && !defined(BUILD_GLOBALBOOST_INTERNAL)
