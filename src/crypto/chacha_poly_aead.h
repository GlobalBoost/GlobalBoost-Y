...
#ifndef GLOBALBOOST_CRYPTO_CHACHA_POLY_AEAD_H
#define GLOBALBOOST_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@globalboost.
 *
 ...
 *
 * The chacha20-poly1305@globalboost combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@globalboost cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@globalboost are relatively fast in
...
#endif // GLOBALBOOST_CRYPTO_CHACHA_POLY_AEAD_H
