...
void WalletModel::sendCoins(WalletModelTransaction& transaction)
{
...

    {
        ...
        {
            if (!rcp.message.isEmpty()) // Message from normal globalboost:URI (globalboost:123...?message=example)
...
bool WalletModel::bumpFee(uint256 hash, uint256& new_hash)
{
    ...
    const bool always_show_unsigned{getOptionsModel()->getEnablePSBSTYontrols()};
