...
//! Entry point for GlobalBoostApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GlobalBoostApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GlobalBoostGUI tests.
void AppTests::guiTests(GlobalBoostGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GlobalBoostGUI::consoleShown, this, &AppTests::consoleTests);
