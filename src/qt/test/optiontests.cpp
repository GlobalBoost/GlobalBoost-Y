...
{
    // Test regression https://github.com/globalboost/globalboost/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/globalboost-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/globalboost-core/gui/pull/568.
    // With fListen=false in ~/.config/GlobalBoost/GlobalBoost-Qt.conf and all else left as default,
    // globalboost-qt should set both -listen and -listenonion to false and start successfully.
