      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->globalboostAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->globalboostAtStartup);
    ...
    ui->globalboostAtStartup->setToolTip(ui->globalboostAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->globalboostAtStartup->setText(ui->globalboostAtStartup->text().arg(PACKAGE_NAME));

    ui->openGlobalBoostConfButton->setToolTip(ui->openGlobalBoostConfButton->toolTip().arg(PACKAGE_NAME));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBSTYontrols);
