...
#ifndef GLOBALBOOST_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define GLOBALBOOST_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // GLOBALBOOST_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
