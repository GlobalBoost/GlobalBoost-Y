...
#ifndef GLOBALBOOST_WALLET_SCRIPTPUBKEYMAN_H
#define GLOBALBOOST_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The GlobalBoost Core wallet was originally a collection of unrelated private
...
#endif // GLOBALBOOST_WALLET_SCRIPTPUBKEYMAN_H
