...
#ifndef GLOBALBOOST_IPC_PROCESS_H
#define GLOBALBOOST_IPC_PROCESS_H
...
//! IPC process interface for spawning globalboost processes and serving requests
...
#endif // GLOBALBOOST_IPC_PROCESS_H
