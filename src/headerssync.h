...
#ifndef GLOBALBOOST_HEADERSSYNC_H
#define GLOBALBOOST_HEADERSSYNC_H
 ...
 *
 * The GlobalBoost protocol does not offer an easy way to determine the work on a
...
#endif // GLOBALBOOST_HEADERSSYNC_H
