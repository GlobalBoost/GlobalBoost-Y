...
#ifndef GLOBALBOOST_SCRIPT_MINISCRIPT_H
#define GLOBALBOOST_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a globalboost script
...
#endif // GLOBALBOOST_SCRIPT_MINISCRIPT_H
