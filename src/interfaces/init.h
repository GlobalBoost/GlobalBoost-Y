...
#ifndef GLOBALBOOST_INTERFACES_INIT_H
#define GLOBALBOOST_INTERFACES_INIT_H
...
//! (globalboost-gui, globalboost-node, globalboost-wallet, globalboostd, globalboost-qt) and each
...
#endif // GLOBALBOOST_INTERFACES_INIT_H
