        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The GlobalBoost address (only if a well-defined address exists)"},
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (globalboost-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
    ...
    const fs::path& temppath)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/globalboost/globalboost/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
