...
#ifndef GLOBALBOOST_UTIL_SETTINGS_H
#define GLOBALBOOST_UTIL_SETTINGS_H
...
//!       https://github.com/globalboost/globalboost/pull/15934/files#r337691812)
...
#endif // GLOBALBOOST_UTIL_SETTINGS_H
