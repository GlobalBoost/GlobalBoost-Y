...
#ifndef GLOBALBOOST_UTIL_MESSAGE_H
#define GLOBALBOOST_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's globalboost address, it must refer to a public key.
...
#endif // GLOBALBOOST_UTIL_MESSAGE_H
