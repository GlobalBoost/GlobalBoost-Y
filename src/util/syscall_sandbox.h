...
#ifndef GLOBALBOOST_UTIL_SYSCALL_SANDBOX_H
#define GLOBALBOOST_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during globalboostd initialization if GlobalBoost Core was compiled
...
#endif // GLOBALBOOST_UTIL_SYSCALL_SANDBOX_H
