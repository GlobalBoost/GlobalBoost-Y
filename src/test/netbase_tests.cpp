...
{
    BOOST_CHECK(TestSplitHost("www.globalboostcore.org", "www.globalboostcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.globalboostcore.org]", "www.globalboostcore.org", 0));
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:8226", "127.0.0.1", 8226));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8226", "127.0.0.1", 8226));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8226", "::ffff:127.0.0.1", 8226));
    BOOST_CHECK(TestSplitHost("[::]:8226", "::", 8226));
    BOOST_CHECK(TestSplitHost("::8226", "::8226", 0));
    BOOST_CHECK(TestSplitHost(":8226", "", 8226));
    BOOST_CHECK(TestSplitHost("[]:8226", "", 8226));
    ...
    BOOST_CHECK(TestSplitHost("www.globalboostcore.org:65536", "www.globalboostcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.globalboostcore.org:0", "www.globalboostcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.globalboostcore.org:", "www.globalboostcore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8226", "127.0.0.1:8226"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8226", "[::]:8226"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
