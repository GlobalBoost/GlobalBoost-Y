...
First, in terms of structure, there is no particular concept of "GlobalBoost Core
...
Before you start contributing, familiarize yourself with the GlobalBoost Core build
system and tests. Refer to the documentation in the repository on how to build
GlobalBoost Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/globalboost/globalboost/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/globalboost/globalboost/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[GlobalBoost Core PR Review Club](https://globalboostcore.reviews/) meeting.
...
Most communication about GlobalBoost Core development happens on IRC, in the
`#globalboost-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#globalboost-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/globalboost-core-dev/](https://www.erisian.com.au/globalboost-core-dev/)
and [https://gnusha.org/globalboost-core-dev/](https://gnusha.org/globalboost-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/globalboost-dev)
...
For GUI-related issues or pull requests, the https://github.com/globalboost-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/globalboost/globalboost node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to globalboost-qt
...
fork of GlobalBoost Core copies the merge. Instead, make any username mentions in a
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/globalboost/globalboost  # Fetch the latest upstream commit
...
https://github.com/globalboost/globalboost/pull/16189).

Also see the [backport.py script](
https://github.com/globalboost-core/globalboost-maintainer-tools#backport).
