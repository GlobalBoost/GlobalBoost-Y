...
The ZeroMQ feature in GlobalBoost Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ globalboostd -zmqpubhashtx=tcp://127.0.0.1:28225 \
               -zmqpubhashtx=tcp://192.168.1.2:28225 \
               -zmqpubhashblock="tcp://[::1]:28226" \
...
terminator). These options can also be provided in globalboost.conf.
