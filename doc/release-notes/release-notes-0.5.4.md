GlobalBoost version 0.5.4 is now available for download at:
http://sourceforge.net/projects/globalboost/files/GlobalBoost/globalboost-0.5.4/
...
http://gitorious.org/globalboost/globalboostd-stable/archive-tarball/v0.5.4#.tar.gz
...
Remove wxGlobalBoost properly when installing GlobalBoost-Qt over it. (Windows)
