...
Then, to tunnel a SSL connection on 28225 to a RPC server bound on localhost on port 18225 do:

    stunnel -d 28225 -r 127.0.0.1:18225 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:8225/
        ProxyPassReverse http://127.0.0.1:8225/
