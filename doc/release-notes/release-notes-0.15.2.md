GlobalBoost Core version *0.15.2* is now available from:

  <https://globalboostcore.org/bin/globalboost-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in globalboost-tx (TheBlueMatt)
