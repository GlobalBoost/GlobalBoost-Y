GlobalBoost Core version 0.10.3 is now available from:

  <https://globalboost.org/bin/globalboost-core-0.10.3/>
...
(see https://github.com/globalboost/globalboost/pull/6793, as well as the 0.11.0
