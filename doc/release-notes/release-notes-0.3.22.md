Download URL: https://sourceforge.net/projects/globalboost/files/GlobalBoost/globalboost-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BSTY fee schedule (users still pay 0.01 BSTY per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #globalboost00 - #globalboost99
