GlobalBoost Core version 0.9.2.1 is now available from:

  https://globalboost.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BSTY to 0.01 BSTY
...
- Fix "Start globalboost on system login"
