GlobalBoost Core version 0.10.4 is now available from:

  <https://globalboost.org/bin/globalboost-core-0.10.4/>
...
- #6953 `43c2789` Split globalboost-tx into its own package
- #6953 `dfe0d4d` Include globalboost-tx binary on Debian/Ubuntu
