...
GlobalBoost Core version 0.21.1 is now available from:

  <https://globalboostcore.org/bin/globalboost-core-0.21.1/>
...
fungibility of all globalboosts. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to GlobalBoost Core's wallet is
...
FAQ](https://globalboostcore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/globalboost/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/globalboost/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/globalboost/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit GlobalBoost](https://globalboostmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-globalboost)
  - [What do Schnorr Signatures Mean for GlobalBoost?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-globalboost)
...
- Development history overview
  - [Taproot](https://globalboostops.org/en/topics/taproot/)
  - [Schnorr signatures](https://globalboostops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://globalboostops.org/en/topics/tapscript/)
  - [Soft fork activation](https://globalboostops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://globalboost.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/globalboost/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/globalboost/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to globalboost.conf documentation (jonatack)
