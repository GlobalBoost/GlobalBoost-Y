GlobalBoost Core version 0.16.1 is now available from:

  <https://globalboostcore.org/bin/globalboost-core-0.16.1/>
...
- #12843 `df38b13` Test starting globalboostd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure globalboostd processes are cleaned up when tests end (sdaftuar)
