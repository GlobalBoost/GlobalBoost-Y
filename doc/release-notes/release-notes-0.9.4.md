GlobalBoost Core version 0.9.4 is now available from:

  https://globalboost.org/bin/0.9.4/
...
this update is incompatible with the GlobalBoost system and could lead to consensus
forks.

GlobalBoost Core released binaries from https://globalboost.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~globalboost/+archive/ubuntu/globalboost
- A third-party or self-compiled GlobalBoost Core

upgrade to GlobalBoost Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
