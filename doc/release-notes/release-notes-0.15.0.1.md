GlobalBoost Core version *0.15.0.1* is now available from:

  <https://globalboost.org/bin/globalboost-core-0.15.0.1/>

and

  <https://globalboostcore.org/bin/globalboost-core-0.15.0.1/>
