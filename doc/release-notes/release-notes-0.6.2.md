GlobalBoost version 0.6.2 is now available for download at:
http://sourceforge.net/projects/globalboost/files/GlobalBoost/globalboost-0.6.2/
...
Fixed https://github.com/globalboost/globalboost/issues/1065, a bug that
