...
The interface runs on the same port as the JSON-RPC interface, by default port 8225 for mainnet, port 18225 for testnet,
port 38225 for signet, and port 18443 for regtest.
...
See [BIP64](https://github.com/globalboost/bips/blob/master/bip-0064.mediawiki) for
...
Risks
-------------
Running a web browser on the same node with a REST enabled globalboostd can be a risk. Accessing prepared XSS websites could read out tx/block data of your node by placing links like `<script src="http://127.0.0.1:8225/rest/tx/1234567890.json">` which might break the nodes privacy.
