#############################################################################
# Makefile for building: GlobalBoost-Y
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Sep 8 17:28:10 2014
# Project:  GlobalBoost-Y.pro
# Template: app
# Command: /usr/bin/qmake USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile GlobalBoost-Y.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_WEBKIT_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtWebKit -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lqrencode -lminiupnpc /home/bst32/Desktop/GlobalBoost-Y-20140908/src/leveldb/libleveldb.a /home/bst32/Desktop/GlobalBoost-Y-20140908/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtWebKit -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: GlobalBoost-Y.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile GlobalBoost-Y.pro
...
/home/bst32/Desktop/GlobalBoost-Y-20140908/src/leveldb/libleveldb.a: FORCE
	cd /home/bst32/Desktop/GlobalBoost-Y-20140908/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/bst32/Desktop/GlobalBoost-Y-20140908/build/build.h: FORCE
	cd /home/bst32/Desktop/GlobalBoost-Y-20140908; /bin/sh share/genbuild.sh /home/bst32/Desktop/GlobalBoost-Y-20140908/build/build.h
...
build/moc_servicemessagespage.cpp: src/qt/servicemessagespage.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/servicemessagespage.h -o build/moc_servicemessagespage.cpp

build/moc_dialog_move_handler.cpp: src/qt/dialog_move_handler.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/dialog_move_handler.h -o build/moc_dialog_move_handler.cpp
...
build/moc_servicemessagedialog.cpp: src/qt/servicemessagedialog.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/servicemessagedialog.h -o build/moc_servicemessagedialog.cpp
...
qrc_res.cpp: src/qt/res.qrc \
	...
	/usr/bin/rcc -name res src/qt/res.qrc -o qrc_res.cpp
...
build/ui_servicemessagespage.h: src/qt/forms/servicemessagespage.ui
	/usr/bin/uic-qt4 src/qt/forms/servicemessagespage.ui -o build/ui_servicemessagespage.h

build/ui_mainwindow.h: src/qt/forms/mainwindow.ui
	/usr/bin/uic-qt4 src/qt/forms/mainwindow.ui -o build/ui_mainwindow.h
...
build/ui_transactionspage.h: src/qt/forms/transactionspage.ui
	/usr/bin/uic-qt4 src/qt/forms/transactionspage.ui -o build/ui_transactionspage.h
...
build/yescrypt-opt.o: src/yescrypt-opt.c src/sha256_Y.h \
		src/sysendian.h \
		src/yescrypt-platform.c \
		src/yescrypt.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/yescrypt-opt.o src/yescrypt-opt.c
