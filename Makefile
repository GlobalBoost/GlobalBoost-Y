...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Sep 10 10:54:37 2014
# Project:  GlobalBoost-Y.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile GlobalBoost-Y.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_WEBKIT_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O2 -march=native -D_REENTRANT -Wall -W $(DEFINES)
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lminiupnpc /home/bst32/Desktop/GlobalBoost-Y/src/leveldb/libleveldb.a /home/bst32/Desktop/GlobalBoost-Y/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtWebKit -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/qt/chatwindow.cpp build/moc_bitcoingui.cpp \
...
Makefile: GlobalBoost-Y.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Makefile GlobalBoost-Y.pro
...
/home/bst32/Desktop/GlobalBoost-Y/src/leveldb/libleveldb.a: FORCE
	cd /home/bst32/Desktop/GlobalBoost-Y/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/bst32/Desktop/GlobalBoost-Y/build/build.h: FORCE
	cd /home/bst32/Desktop/GlobalBoost-Y; /bin/sh share/genbuild.sh /home/bst32/Desktop/GlobalBoost-Y/build/build.h
