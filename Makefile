#############################################################################
# Makefile for building: GlobalBoost-Y.app/Contents/MacOS/GlobalBoost-Y
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Sep 16 05:07:30 2014
# Project:  GlobalBoost-Y.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=1 USE_QRCODE=1 -o Makefile GlobalBoost-Y.pro
#############################################################################
...
CC            = /usr/bin/clang
CXX           = /usr/bin/clang++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_WEBKIT_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.7 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.7 -pthread -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -Ibuild -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtWebKit.framework/Versions/4/Headers -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -I/opt/local/include/db48 -I/opt/local/Library/Frameworks/QtWebKit.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/include -Ibuild -F/opt/local/Library/Frameworks -F/opt/local/lib
LINK          = /usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -fstack-protector-all -arch x86_64 -pthread -Xarch_x86_64 -mmacosx-version-min=10.7
LIBS          = $(SUBLIBS) -F/opt/local/Library/Frameworks -F/opt/local/lib  -lqrencode -lminiupnpc /Users/User/Desktop/GlobalBoost-Y/src/leveldb/libleveldb.a /Users/User/Desktop/GlobalBoost-Y/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -framework CoreServices -L/opt/local/lib -L/opt/local/lib/db48 -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_chrono-mt -F/opt/local/Library/Frameworks -F/opt/local/lib -framework QtWebKit -framework QtGui -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
...
OBJECTS       = build/macdockiconhandler.o \
		...
		build/rpcconsole.o \
		build/sha256_Y.o \
		build/yescryptcommon.o \
		build/yescrypt-best.o \
		build/noui.o \
		build/leveldb.o \
		build/txdb.o \
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		GlobalBoost-Y.pro
QMAKE_TARGET  = GlobalBoost-Y
DESTDIR       = 
TARGET        = GlobalBoost-Y.app/Contents/MacOS/GlobalBoost-Y
...
all: Makefile GlobalBoost-Y.app/Contents/PkgInfo GlobalBoost-Y.app/Contents/Resources/empty.lproj GlobalBoost-Y.app/Contents/Info.plist GlobalBoost-Y.app/Contents/Resources/globalboost.icns $(TARGET)

$(TARGET): /Users/User/Desktop/GlobalBoost-Y/src/leveldb/libleveldb.a /Users/User/Desktop/GlobalBoost-Y/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_chatwindow.h build/ui_servicemessagespage.h build/ui_mainwindow.h build/ui_miningpage.h build/ui_transactionspage.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) GlobalBoost-Y.app/Contents/MacOS/ || $(MKDIR) GlobalBoost-Y.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: GlobalBoost-Y.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=1 USE_QRCODE=1 -o Makefile GlobalBoost-Y.pro
...
GlobalBoost-Y.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) GlobalBoost-Y.app/Contents || $(MKDIR) GlobalBoost-Y.app/Contents 
	@$(DEL_FILE) GlobalBoost-Y.app/Contents/PkgInfo
	@echo "APPL????" >GlobalBoost-Y.app/Contents/PkgInfo
GlobalBoost-Y.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) GlobalBoost-Y.app/Contents/Resources || $(MKDIR) GlobalBoost-Y.app/Contents/Resources 
	@touch GlobalBoost-Y.app/Contents/Resources/empty.lproj
	
GlobalBoost-Y.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) GlobalBoost-Y.app/Contents || $(MKDIR) GlobalBoost-Y.app/Contents 
	@$(DEL_FILE) GlobalBoost-Y.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.9,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,globalboost.icns,g" -e "s,@EXECUTABLE@,GlobalBoost-Y,g" -e "s,@TYPEINFO@,????,g" share/qt/Info.plist >GlobalBoost-Y.app/Contents/Info.plist
GlobalBoost-Y.app/Contents/Resources/globalboost.icns: src/qt/res/icons/globalboost.icns
	@$(CHK_DIR_EXISTS) GlobalBoost-Y.app/Contents/Resources/ || $(MKDIR) GlobalBoost-Y.app/Contents/Resources/ 
	@$(DEL_FILE) GlobalBoost-Y.app/Contents/Resources/globalboost.icns
	@$(COPY_FILE) src/qt/res/icons/globalboost.icns GlobalBoost-Y.app/Contents/Resources/globalboost.icns
dist: 
	@$(CHK_DIR_EXISTS) build/GlobalBoost-Y0.9.0.1 || $(MKDIR) build/GlobalBoost-Y0.9.0.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/checkpointsync.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/yescrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/qt/serveur.h src/qt/servicemessagespage.h src/qt/dialog_move_handler.h src/qt/qtipcserver.h src/qt/miningpage.h src/qt/servicemessagedialog.h src/qt/chatwindow.h src/qt/qrcodedialog.h src/qt/macdockiconhandler.h src/qt/macnotificationhandler.h build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc src/qt/res.qrc build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/checkpointsync.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/sha256_Y.c src/yescryptcommon.c src/yescrypt-best.c src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/qt/serveur.cpp src/qt/servicemessagespage.cpp src/qt/dialog_move_handler.cpp src/qt/qtipcserver.cpp src/qt/miningpage.cpp src/qt/servicemessagedialog.cpp src/qt/chatwindow.cpp src/qt/qrcodedialog.cpp build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/chatwindow.ui src/qt/forms/servicemessagespage.ui src/qt/forms/mainwindow.ui src/qt/forms/miningpage.ui src/qt/forms/transactionspage.ui src/qt/forms/qrcodedialog.ui build/GlobalBoost-Y0.9.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/GlobalBoost-Y0.9.0.1/ && (cd `dirname build/GlobalBoost-Y0.9.0.1` && $(TAR) GlobalBoost-Y0.9.0.1.tar GlobalBoost-Y0.9.0.1 && $(COMPRESS) GlobalBoost-Y0.9.0.1.tar) && $(MOVE) `dirname build/GlobalBoost-Y0.9.0.1`/GlobalBoost-Y0.9.0.1.tar.gz . && $(DEL_FILE) -r build/GlobalBoost-Y0.9.0.1


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /Users/User/Desktop/GlobalBoost-Y/src/leveldb/libleveldb.a; cd /Users/User/Desktop/GlobalBoost-Y/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
distclean: clean
	-$(DEL_FILE) -r GlobalBoost-Y.app
	-$(DEL_FILE) Makefile


/Users/User/Desktop/GlobalBoost-Y/src/leveldb/libleveldb.a: FORCE
	cd /Users/User/Desktop/GlobalBoost-Y/src/leveldb && CC=/usr/bin/clang CXX=/usr/bin/clang++ $(MAKE) OPT="-pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Users/User/Desktop/GlobalBoost-Y/build/build.h: FORCE
	cd /Users/User/Desktop/GlobalBoost-Y; /bin/sh share/genbuild.sh /Users/User/Desktop/GlobalBoost-Y/build/build.h
...
build/moc_servicemessagespage.cpp: src/qt/servicemessagespage.h
	/opt/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/servicemessagespage.h -o build/moc_servicemessagespage.cpp

build/moc_dialog_move_handler.cpp: src/qt/dialog_move_handler.h
	/opt/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/dialog_move_handler.h -o build/moc_dialog_move_handler.cpp
...
build/moc_servicemessagedialog.cpp: src/qt/servicemessagedialog.h
	/opt/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/servicemessagedialog.h -o build/moc_servicemessagedialog.cpp
...
compiler_rcc_make_all: qrc_bitcoin.cpp qrc_res.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_bitcoin.cpp qrc_res.cpp
...
qrc_res.cpp: src/qt/res.qrc \
		...
		src/qt/res/movies/spinning_earth_globe_25.gif \
		...
		src/qt/res/icons/group.png \
		src/qt/res/icons/transactions.png \
		src/qt/res/icons/Exclamation-mark.png \
		src/qt/res/icons/address_book.png \
		src/qt/res/icons/sign_message.png \
		src/qt/res/icons/verify_message.png \
		src/qt/res/icons/home.png \
		src/qt/res/icons/Question-mark.png \
	...
	/opt/local/bin/rcc -name res src/qt/res.qrc -o qrc_res.cpp
...
build/ui_servicemessagespage.h: src/qt/forms/servicemessagespage.ui
	/opt/local/bin/uic src/qt/forms/servicemessagespage.ui -o build/ui_servicemessagespage.h

build/ui_mainwindow.h: src/qt/forms/mainwindow.ui
	/opt/local/bin/uic src/qt/forms/mainwindow.ui -o build/ui_mainwindow.h
...
build/ui_transactionspage.h: src/qt/forms/transactionspage.ui
	/opt/local/bin/uic src/qt/forms/transactionspage.ui -o build/ui_transactionspage.h
...
build/sha256_Y.o: src/sha256_Y.c src/sysendian.h \
		src/sha256_Y.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/sha256_Y.o src/sha256_Y.c

build/yescryptcommon.o: src/yescryptcommon.c src/yescrypt.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/yescryptcommon.o src/yescryptcommon.c

build/yescrypt-best.o: src/yescrypt-best.c src/yescrypt-simd.c \
		src/sha256_Y.h \
		src/sysendian.h \
		src/yescrypt.h \
		src/yescrypt-platform.c \
		src/yescrypt-opt.c
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/yescrypt-best.o src/yescrypt-best.c
