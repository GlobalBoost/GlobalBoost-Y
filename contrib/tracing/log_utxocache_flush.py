...
"""Example logging GlobalBoost Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/globalboostd
...
def main(globalboostd_path):
    ...
    b = BPF(text=program, usdt_contexts=[globalboostd_with_usdts])
