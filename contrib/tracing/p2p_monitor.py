...
""" Interactive globalboostd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for GlobalBoost Core can enable. It uses BCC
...
def main(globalboostd_path):
    ...
    globalboostd_with_usdts.enable_probe(
