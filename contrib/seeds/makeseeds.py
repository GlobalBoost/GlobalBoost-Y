...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of globalboost node seed ip addresses.')
...
def main():
    ...
    print(f'{ip_stats(ips):s} Filter out hosts with multiple globalboost ports', file=sys.stderr)
