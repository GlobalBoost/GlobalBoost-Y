...
# Extract options
function __fish_globalboost_tx_get_options
...
# Extract commands
function __fish_globalboost_tx_get_commands
...
# Add options
complete \
    --command globalboost-tx \
    --condition "not __fish_globalboost_seen_cmd (__fish_globalboost_tx_get_commands --commandsonly)" \
    --arguments "(__fish_globalboost_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command globalboost-tx \
    --arguments "(__fish_globalboost_tx_get_commands)" \
    --no-files
