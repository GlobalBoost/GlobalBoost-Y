...
complete --command globalboost-qt --no-files

# Extract options
function __fish_globalboostqt_get_options
...
complete \
    --command globalboost-qt \
    --arguments "(__fish_globalboostqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c globalboost-qt \
...
complete \
    --command globalboost-qt \
    --arguments "(__fish_globalboostqt_get_options --nofiles)"
