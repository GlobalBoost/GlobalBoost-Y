...
As of GlobalBoost Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/globalboost-core/guix.sigs/). When
...
builder-keys](https://github.com/globalboost-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://globalboostcore.org and https://globalboost.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/globalboost-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/globalboost-24.0.1-arm-linux-gnueabihf.tar.gz
```
