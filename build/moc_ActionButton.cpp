...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ActionButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 42, 0)
    ...
    "ActionButton\0updateButtonStatusFromAction\0"
    "\0"
};
...
void ActionButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateButtonStatusFromAction(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ActionButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_ActionButton.data,
      qt_meta_data_ActionButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ActionButton.stringdata))
