...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Globalboost - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Globalboost Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Globalboost debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Globalboost-Qt help message to get a list with possible Globalboost command-line options.", 0));
#endif // QT_NO_TOOLTIP
