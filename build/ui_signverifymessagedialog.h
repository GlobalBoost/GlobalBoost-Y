...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        SignVerifyMessageDialog->resize(643, 372);
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/default/res/themes/default/icons/light/sign-in.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/default/res/themes/default/icons/light/paste.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/default/res/themes/default/icons/light/copy.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        sizePolicy.setHeightForWidth(signMessageButton_SM->sizePolicy().hasHeightForWidth());
        signMessageButton_SM->setSizePolicy(sizePolicy);
        signMessageButton_SM->setIcon(icon);
        ...
        sizePolicy.setHeightForWidth(clearButton_SM->sizePolicy().hasHeightForWidth());
        clearButton_SM->setSizePolicy(sizePolicy);
        QIcon icon3;
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/default/res/themes/default/icons/light/address-book.png"), QSize(), QIcon::Normal, QIcon::Off);
        addressBookButton_VM->setIcon(icon4);
        ...
        sizePolicy.setHeightForWidth(verifyMessageButton_VM->sizePolicy().hasHeightForWidth());
        verifyMessageButton_VM->setSizePolicy(sizePolicy);
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/default/res/themes/default/icons/light/verify.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        sizePolicy.setHeightForWidth(clearButton_VM->sizePolicy().hasHeightForWidth());
        clearButton_VM->setSizePolicy(sizePolicy);
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. GlobalboostfwYhBmGXcFP2Po1NpRUEiK8km2)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this Globalboost address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address the message was signed with (e.g. GlobalboostfwYhBmGXcFP2Po1NpRUEiK8km2)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified Globalboost address", 0));
#endif // QT_NO_TOOLTIP
