...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DialogMoveHandler_t, stringdata) + ofs \
...
const QMetaObject DialogMoveHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DialogMoveHandler.data,
      qt_meta_data_DialogMoveHandler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogMoveHandler.stringdata))
