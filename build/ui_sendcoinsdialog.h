...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        buttonBar = new QWidget(SendCoinsDialog);
        buttonBar->setObjectName(QStringLiteral("buttonBar"));
        horizontalLayout = new QHBoxLayout(buttonBar);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(9, 30, 9, 20);
        addButton = new QPushButton(buttonBar);
        addButton->setObjectName(QStringLiteral("addButton"));
        addButton->setMaximumSize(QSize(136, 36));
        ...
        clearButton->setMaximumSize(QSize(100, 36));
        ...
        labelBalance = new QLabel(buttonBar);
        ...
        sendButton = new QPushButton(buttonBar);
        sendButton->setObjectName(QStringLiteral("sendButton"));
        sendButton->setMaximumSize(QSize(96, 36));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 BSTY", 0));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 BSTY", 0));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 BSTY", 0));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 BSTY", 0));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 BSTY", 0));
#ifndef QT_NO_TOOLTIP
