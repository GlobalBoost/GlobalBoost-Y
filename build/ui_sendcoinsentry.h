...
public:
    ...
    QValidatedLineEdit *addAsLabel1;
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/default/res/themes/default/icons/light/address-book.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        addAsLabel1 = new QValidatedLineEdit(SendCoinsEntry);
        addAsLabel1->setObjectName(QStringLiteral("addAsLabel1"));

        gridLayout->addWidget(addAsLabel1, 4, 1, 1, 1);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The BSTY address to send the payment to  (e.g. NfwYhBmGXcFP2Po1NpRUEiK8km2)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addAsLabel1->setToolTip(QApplication::translate("SendCoinsEntry", "Enter a label for this address to add it to your address book", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
