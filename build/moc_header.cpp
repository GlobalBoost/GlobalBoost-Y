...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Header_t, stringdata) + ofs \
...
const QMetaObject Header::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Header.data,
      qt_meta_data_Header,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Header.stringdata))
